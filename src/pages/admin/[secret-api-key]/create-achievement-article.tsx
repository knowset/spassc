...
const postAchievement = async ({ title, content, images }: {title: string, content: string, images: string}) => {
...
const CreateAchievement = () => {
    ...
    const createAchievement = async () => {
        ...
        await postAchievement({ title, content, images });
        ...
        <Main currentPage="">
            <div className="t-flex t-flex-col t-gap-4 t-pt-8 t-px-12 t-mb-12">
                <div className="t-flex t-flex-col t-justify-center t-items-center t-gap-4">
                    <p className="t-text-2xl t-font-bold">Создать статью про спортивные достижения</p>
